...
disease_cols_group2 = {
    'ihd_diag': 'IHD',
    'stroke_or_tia_diag3': 'Stroke/transient ischemic attack',
    'diabetes_diag3': 'Diabetes',
    'hypertension_diag3': 'Hypertension',
}
...
# 按照指定顺序重新排列列
ordered_diseases = ['IHD', 'Stroke/transient ischemic attack', 'Diabetes', 'Hypertension']
pivot_data2 = pivot_data2.reindex(columns=ordered_diseases)
...
plt.tight_layout()
plt.savefig('other_diseases_bar_new.png', dpi=1200, bbox_inches='tight', facecolor='white')
plt.close()

print("\n直方图绘制完成！")
print("\n生成文件：")
# print("1. eye_diseases_bar.png - 眼病患病率直方图")
print("2. other_diseases_bar_new.png - 其他疾病患病率直方图") 